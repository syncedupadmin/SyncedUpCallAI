...
export async function GET(req: NextRequest) {
  ...
  if (!isAdmin) {
    console.warn('[DEPRECATED] /api/reports/rollups accessed without auth');
    return unauthorizedResponse();
  }

  console.warn('[DEPRECATED] /api/reports/rollups is deprecated and unused. Consider removing.');
  try {
