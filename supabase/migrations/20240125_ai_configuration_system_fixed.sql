-- AI Configuration Management System Schema (FIXED VERSION)
...
GRANT EXECUTE ON FUNCTION calculate_keyword_impact TO authenticated;
GRANT EXECUTE ON FUNCTION recommend_keyword_action TO authenticated;
GRANT EXECUTE ON FUNCTION analyze_overtuning TO authenticated;